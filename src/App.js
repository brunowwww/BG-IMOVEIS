...
export default function App() {
  ...
  ArrImoveis?.map((imovel) => { // mapeia o State para pegar cada posição da array
    const cardImovel = (
  ...
  function Ordena() { //função que ordena os imoveis
